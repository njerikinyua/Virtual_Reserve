...
<head>
    <meta charset="utf-8">
    <title>Virtual Reserve - Administrator Module</title>
    ...
    <div class="container" id="data">
        <div class="rw align-items-center">
            <div class="col-lg-12 py-5 py-lg-0 px-3 px-lg-5">
                ...
                <h1 class="display-4 mb-4"><span class="text-primary">List</span> of Users</h1>
                <div class="row py-2">
                    <div class="col-12">
...
<td><button id="delbtn" class="btn btn-primary py-3 px-5" onclick="return confirm('Are you sure that you want to delete this user?')?window.location.href='php/functions.php?action=deleteU&id=<?php echo($row["User_ID"]); ?>':true;" title='Delete User'>Delete</button></td>
</tr>
<?php
}
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                    <h1 class="display-4 mb-4">Register A User</h1>
                        <form class="py-5" name="" method="POST" action="php/functions.php">
                            <div class="form-group">
                                <input type="text" class="form-control border-0 p-4" placeholder="Your Name" name="fname" required="required" />
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control border-0 p-4" placeholder="Your Email" name="email" required="required" />
                            </div>
                            <div class="form-group">
                                <input type="text" minlength="13" class="form-control border-0 p-4" placeholder="Your Phone Number" required="required" name="phone" />
                            </div>
                            <div class="form-group">
                                <select class="custom-select border-0 px-4" style="height: 47px;" required name="type">
                            ...
                            <div class="form-group">
                                <input type="password" minlength="8" id="pass" class="form-control border-0 p-4" placeholder="Your Password" required="required" name="password" />
                                <br>
                                <input type="checkbox" name="" onclick="showPass();"> <p style="color: white;">Show Password</p>
                            </div>
                            <div class="form-group">
                                <input type="password" minlength="8" id="pass1" class="form-control border-0 p-4" placeholder="Confirm Your Password" name="cpassword" required="required" />
                                <br>
                                <input type="checkbox" name="" onclick="showPass1();"> <p style="color: white;">Show Password</p>
                            </div>                      
                            <div>
