...
if (!isset($_SESSION['username1']) && !isset($_SESSION['wildlife_id'])) {
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                    <h1 class="display-4 mb-4">Kindly Donate To <?php echo $wildlife['common_name']; ?>!</h1>
                        <form class="py-5" name="" method="POST" action="php/functions.php">
                            <div class="form-group">
                                <input type="number" class="form-control border-0 p-4" placeholder="Donation Amount (in kshs.)" name="amo" min="50" required="required" />
                            </div>                     
                            <div>
                                <button class="btn btn-dark btn-block border-0 py-3" type="submit" name="addd">Donate</button>
                            </div>
                        </form>
                    </div>
                    </div>
